...
(custom-theme-set-faces
 'manoj-fix
 '(default ((t (:family "Ricty" :foundry "PfEd" :width normal :height 128 :weight normal :slant normal :underline nil :overline nil :strike-through nil :box nil :inverse-video nil :foreground "WhiteSmoke" :background "black" :stipple nil :inherit nil))))
 ...
 '(trailing-whitespace ((((class color) (background light)) (:background "DarkGray")) (((class color) (background dark)) (:background "DarkGray")) (t (:inverse-video t))))
 ...
 '(font-lock-comment-face ((t (:background "#061c1c" :foreground "chocolate1" :slant oblique))))
 ...
 '(mode-line ((t (:height 0.9 :box (:line-width 1 :color nil :style nil) :inverse-video nil :foreground "black" :background "grey85"))))
 '(mode-line-buffer-id ((t (:height 0.9 :weight bold :inherit (sml/filename)))))
 '(mode-line-emphasis ((t (:weight bold))))
 '(mode-line-highlight ((t (:box (:line-width 2 :color "grey40" :style released-button)))))
 '(mode-line-inactive ((t (:height 0.9 :weight light :box (:line-width 1 :color nil :style nil) :inverse-video nil :foreground "grey20" :background "#fdf6e3"))))
